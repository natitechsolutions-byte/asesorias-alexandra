            ...
            <div className="relative max-w-[1600px] mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-14 items-center">
                    <div>
                        ...
                        <p className="mt-6 text-gray-600 leading-relaxed">
                            Asesorías Alexandra es el resultado de un proceso de formación académica,
                            experiencia práctica y trabajo constante junto a empresas de distintos rubros y
                            tamaños.
                        </p>

                        <p className="mt-4 text-gray-600 leading-relaxed">
                            Su propósito es entregar apoyo contable, tributario, laboral y administrativo de manera clara y cercana, ayudando a cada empresa a mantener una gestión ordenada, cumplir sus obligaciones oportunamente y utilizar la información de su negocio para tomar mejores decisiones.
                        </p>
                        <p className="mt-4 text-gray-600 leading-relaxed">
                            Más allá del cumplimiento normativo, buscamos que nuestros clientes comprendan su
                            información financiera, organicen sus recursos, gestionen adecuadamente sus costos y
                            cuenten con herramientas que les permitan proyectar el crecimiento de sus negocios.
                        </p>
                ...
                <div className="mt-20 bg-[#071B3A] text-white rounded-3xl p-8 md:p-12 shadow-2xl">
                    ...
                    <h2 className="text-3xl font-bold mt-3">
                        Más que una oficina contable, un apoyo profesional para la gestión de tu negocio.
                    </h2>
